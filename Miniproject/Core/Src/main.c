...
int main(void)
{
  ...
  do
  {
	  ...
	  arudino_transfer = HAL_GPIO_ReadPin(SENSOR_OUTPUT_GPIO_Port, SENSOR_OUTPUT_Pin);
	 	  HAL_SPI_Transmit(&hspi1, &arudino_transfer, 1, 100);
	 	 // HAL_Delayr(1000);
	   switch(arudino_transfer)
	 	  {
	 	 case 0:
